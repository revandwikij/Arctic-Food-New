<div id="app-sidepanel" class="app-sidepanel">
    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding">
            <a class="app-logo" href="/admin"><img class="logo-icon me-2" src="../assets/css/images/arcticlogo.png"
                    alt="logo"><span class="logo-text">Arctic Food</span></a>
        </div><!--//app-branding-->
            ...
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            ...
                            <li class="submenu-item"><a class="submenu-link" href="/users">Data Pelanggan</a></li>
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="/perludikirim">Perlu Dikirim</a>
                            </li>
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-3" class="collapse submenu submenu-3" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="/laporanbarang">Laporan Barang</a>
                            </li>
                            {{-- <li class="submenu-item"><a class="submenu-link" href="#">Dikirim</a></li> --}}
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/backupdb">
                        ...
                        <span class="nav-link-text">Cadangkan Data</span>
                    </a><!--//nav-link-->
                </li><!--//nav-item-->
