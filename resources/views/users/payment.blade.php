...
<body>
    ...
    <div class="iphone">
        ...
        <form action="https://httpbin.org/post" class="form" method="POST">
          ...
          <fieldset>
            <legend>Bayar Dengan :</legend>

            <div class="form__radios">
              <div class="form__radio">
                <label for="visa">
                    <img src="/assets/css/images/COD.jpg" alt="COD" style="width: 25px; height: 25px;">
              ...
              <div class="form__radio">
                <label for="paypal">
                    <img src="/assets/css/images/gopay.png" alt="gopay" style="width: 25px; height: 25px;">
                  Gopay</label>
